...
class Vortex_AI_Marketplace {
    ...
    private function load_dependencies() {
        ...
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-vortex-ai-agent-handler.php';
    ...
    private function define_public_hooks() {
        ...
        $this->ai_agent_handler = new Vortex_AI_Agent_Handler($this->get_plugin_name(), $this->get_version());
        
        // Initialize Seed Art Manager
        $this->seed_art_manager = new Vortex_Seed_Art_Manager($this->get_plugin_name(), $this->get_version());
        ...
        $plugin_public->set_ai_agent_handler($this->ai_agent_handler);
        $plugin_public->set_seed_art_manager($this->seed_art_manager);
