...
class VORTEX_DB_Tables {
    ...
    public function create_all_tables() {
        ...
        $this->create_forum_posts_table();
        $this->create_forum_responses_table();
    }
     ...
     */
    public function create_forum_posts_table() {
        global $wpdb;
    ...
    /**
     * Create forum responses table
     */
    public function create_forum_responses_table() {
        global $wpdb;
        $table_name = $wpdb->prefix . 'vortex_forum_responses';
        $charset_collate = $wpdb->get_charset_collate();
